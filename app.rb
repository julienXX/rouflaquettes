...
before do
  ...
  @client = TwitterOAuth::Client.new(
    :consumer_key => 'YSoBZYHBsvtLKU2HYEulLQ', #replace with your own consumer key
    :consumer_secret => 'PF3d95LMLEZQuzHBuPt5hge3RlflOc8MrGSw7GqkHcc', #replace with your own consumer secret
